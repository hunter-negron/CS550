...
javac -d build -cp src/com/lib/thirdparty/json-20210307.jar: src/com/lib/peer_client/FileInfo.java src/com/lib/watch_dir/WatchDir.java src/com/lib/interfaces/RMIClientInterface.java src/com/lib/interfaces/RMIServerInterface.java src/com/lib/index_server/RegisteredPeerInfo.java src/com/lib/index_server/IndexServer.java src/com/lib/peer_client/PeerClient.java src/com/app/CentralServer.java src/com/app/Client.java src/com/test/test_cases/PeerTest1.java
