...
javac -d build src/com/lib/peer_client/FileInfo.java src/com/lib/interfaces/RMIClientInterface.java src/com/lib/interfaces/RMIServerInterface.java src/com/lib/peer_client/PeerClient.java src/com/app/Client.java
